...
const ScCompactAddress = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h("div", { key: '0b27cd5e6995493bc2f8704327cc5c33c39a6cb1', class: "sc-address", part: "base" }, index.h("sc-form-control", { key: 'a020ea376faa5a2248c8f7a71884769f1c2a6f76', exportparts: "label, help-text, form-control", label: this.label, class: "sc-address__control", part: "control", required: this.required }, index.h("sc-select", { key: 'acdc5a07f0a4645bba7cf5c258309c9a2e039819', exportparts: "base:select__base, input, form-control, label, help-text, trigger, panel, caret, search__base, search__input, search__form-control, menu__base, spinner__base, empty", value: (_a = this.address) === null || _a === void 0 ? void 0 : _a.country, onScChange: (e) => {
                this.clearAddress();
                this.updateAddress({ country: e.target.value || null });
            }, choices: this.countryChoices, autocomplete: 'country-name', placeholder: ((_b = this.placeholders) === null || _b === void 0 ? void 0 : _b.country) || wp.i18n.__('Select Your Country', 'surecart'), name: this.names.country, search: true, unselect: false, "squared-bottom": this.showState || this.showPostal, required: this.required }), index.h("div", { key: '3b0e404cd9530252aa968c091abcab3f18359b56', class: "sc-address__columns" }, this.showState && (index.h("sc-select", { key: '8cf5cd0e0f3819bd220efafeda66b46caafa377f', exportparts: "base:select__base, input, form-control, label, help-text, trigger, panel, caret, search__base, search__input, search__form-control, menu__base, spinner__base, empty", placeholder: this.getStatePlaceholder(), name: this.names.state, autocomplete: 'address-level1', value: (_c = this === null || this === void 0 ? void 0 : this.address) === null || _c === void 0 ? void 0 : _c.state, onScChange: (e) => this.updateAddress({ state: e.target.value || null }), choices: this.regions, required: this.required, search: true, "squared-top": true, unselect: false, "squared-right": this.showPostal })), this.showPostal && (index.h("sc-input", { key: '4672c4cf13675c2204443b1485025486cce2e6d1', exportparts: "base:input__base, input, form-control, label, help-text", placeholder: ((_d = this.placeholders) === null || _d === void 0 ? void 0 : _d.postal_code) || wp.i18n.__('Postal Code/Zip', 'surecart'), name: this.names.postal_code, onScChange: (e) => this.updateAddress({ postal_code: e.target.value || null }), onScInput: (e) => this.handleAddressInput({ name: e.target.value || null }), autocomplete: 'postal-code', required: this.required, value: (_e = this === null || this === void 0 ? void 0 : this.address) === null || _e === void 0 ? void 0 : _e.postal_code, "squared-top": true, maxlength: 5, "squared-left": this.showState })))), this.loading && index.h("sc-block-ui", { key: 'c2d43b5f64921e76228da469a326906b4fb42d99', exportparts: "base:block-ui, content:block-ui__content" })));
    }
...
const ScRadio = class {
    ...
    render() {
        ...
        return (index.h(Tag, { key: '10da3deb0356ef2e21cf550474e797118409d11e', part: "base", class: {
                'radio': true,
                'radio--checked': this.checked,
                'radio--disabled': this.disabled,
                'radio--focused': this.hasFocus,
                'radio--editing': this.edit,
            }, htmlFor: this.inputId, onKeyDown: e => this.handleKeyDown(e), onMouseDown: e => this.handleMouseDown(e) }, index.h("span", { key: '5f60707d68d9a62abc849e09bb1ee4408da4e3ec', part: "control", class: "radio__control" }, index.h("span", { key: '5e583365f3fa1a13e61b0a36b1a1b08c6e3dac22', part: "checked-icon", class: "radio__icon" }, index.h("svg", { key: 'eae1fce6267d3c28c53a04aceafb4b13be22874e', viewBox: "0 0 16 16" }, index.h("g", { key: '075d28f941be0c04d7d4d11bbb750a2ad2abb28f', stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd" }, index.h("g", { key: '3c1f603f1c7edb7581bb766bde205f4944b08f59', fill: "currentColor" }, index.h("circle", { key: 'e650dd636501b96c8b4861106cc802d5dcc0e61e', cx: "8", cy: "8", r: "3.42857143" }))))), index.h("input", { key: '667d10ed76a6d6764fc8e5fe1ea5241d8ea2cc17', id: this.inputId, ref: el => (this.input = el), type: "radio", name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, required: this.required, "aria-checked": this.checked ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', "aria-labelledby": this.labelId, onClick: () => this.handleClick(), onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus() })), index.h("span", { key: 'a3a3263f8c523387c763ada0baee6bafcc165d11', part: "label", id: this.labelId, class: "radio__label" }, index.h("slot", { key: 'a4990600b9760c47d44d339520f2a2c382a0ac72' }), index.h("slot", { key: '496d8ec35116ed254c5aade2516e048775c5ccda', name: "description" }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const ScRadioGroup = class {
    ...
    render() {
        return (index.h("fieldset", { key: '78f0654f93c8565f37eb4c6b72bf37dfec582127', part: "base", class: {
                'radio-group': true,
                'radio-group--invalid': this.invalid,
                'radio-group--is-required': this.required,
                'radio-group--is-rtl': pageAlign.isRtl(),
            }, "aria-invalid": this.invalid, role: "radiogroup" }, index.h("legend", { key: 'a7c7d92e3a8a6f09ac4fded67c04964dee9ec563', part: "label", class: "radio-group__label" }, index.h("slot", { key: '64333b9d4792d351f010348843d8735e06d9330a', name: "label" }, this.label)), index.h("input", { key: '1ea2c1c69b47b5afe4c9ee9c598f085cfc227e66', type: "text", class: "radio-group__hidden-input", ref: el => (this.input = el), required: this.required, value: this.value, tabindex: "-1" }), index.h("div", { key: 'da12dccf0d664d24f342d826560a335bf0485e57', part: "items", class: "radio-group__items" }, index.h("slot", { key: '3a5e82b58e4a47d89829f98f27c5c3ba0f7a82ec' }))));
    }
    get el() { return index.getElement(this); }
};
